"""
Production settings for shorturl project.
Import from settings.py and override specific values.
"""
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@goshort.com')
